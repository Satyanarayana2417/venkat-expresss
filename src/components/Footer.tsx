        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/branch" className="text-white/80 hover:text-accent transition-colors">Branch</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/services#purchase" className="text-white/80 hover:text-accent transition-colors">Purchase on Behalf</Link></li>
              <li><Link to="/services#shipping" className="text-white/80 hover:text-accent transition-colors">International Shipping</Link></li>
              <li><Link to="/services#tracking" className="text-white/80 hover:text-accent transition-colors">Package Tracking</Link></li>
              <li><Link to="/services#customs" className="text-white/80 hover:text-accent transition-colors">Customs Support</Link></li>
            </ul>
          </div>
